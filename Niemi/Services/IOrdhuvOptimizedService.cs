...
public interface IOrdhuvOptimizedService
{
    ...
    Task<IEnumerable<OrdhuvDto>> GetOrdersByLicensePlatesAsync(List<LicensePlateItem> licensePlates, string? environment = null, string[]? environments = null, string? orhStat = null, string? customerType = null);
}
